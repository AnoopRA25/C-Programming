...
void highest_sgpa(stud *s, int n);
void searchByName(stud *s, int n, char searchName[10]);
void searchByRollNo(stud *s, int n, int rollNo);
void sortByRollNo(stud *s,int n);
